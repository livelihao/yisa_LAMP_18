...
RANDOM_STATE = 500
X_train, X_test, y_db_train, y_db_test = train_test_split(bottlenecks, kouzhao, test_size=0.15, random_state=RANDOM_STATE)
ss = StandardScaler()
...
clfb = BaggingClassifier(base_estimator= DecisionTreeClassifier(), max_samples=0.5, max_features=0.5).fit(X_train, y_db_train)
